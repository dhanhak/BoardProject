	...
	<form action="" method="post">
		<div class="container">
			...
			<div class="row body">
				...
				<div class="col-8 right">
					<input type="password" name="inputPW" id="input-pw">
				</div>
			</div>
			<div class="row body">
				<div class="col-4 left">이름</div>
				<div class="col-8 right">
					<input type="text" value="${sessionScope.dto.name }"
						name="inputNAME" id="input-name" readonly>
				</div>
			</div>
			<div class="row body">
				<div class="col-4 left">전화번호</div>
				<div class="col-8 right">
					<input type="text" name="inputPHONE" id="input-phone"
						value="${sessionScope.dto.phone }" readonly>
				</div>
			</div>
			<div class="row body">
				<div class="col-4 left">이메일</div>
				<div class="col-8 right">
					<input type="text" name="inputEMAIL" id="input-email"
						value="${sessionScope.dto.email }" readonly>
				</div>
			</div>
			<div class="row body">
				<div class="col-4 left">우편번호</div>
				<div class="col-8 right">
					<input type="text" name="inputPOST" id="sample6_postcode"
						value="${sessionScope.dto.zipcode }" readonly> <input
			...
			<div class="row body">
				...
				<div class="col-8 right">
					<input type="text" name="joindate"
						value="${sessionScope.dto.join_date }" readonly>
				</div>
			</div>
			<div class="row footer">
				<div class="col-12" align="center">
					<button id="cen">취소</button>
